...
void CodeJitter::jit_strict(int num_acts_per_trefi,
  ...
  for (int i = NUM_TIMED_ACCESSES; i < static_cast<int>(aggressor_pairs.size()) - NUM_TIMED_ACCESSES; i++) {
    ...
    a.vpinsrq(asmjit::x86::xmm2, asmjit::x86::xmm2, asmjit::x86::r8, asmjit::Imm(0));
    
    a.mov(asmjit::x86::r9, asmjit::Imm(a_vec[1] - a_vec[0])); 
    a.vpinsrq(asmjit::x86::xmm1, asmjit::x86::xmm2, asmjit::x86::r9, asmjit::Imm(1));

    a.mov(asmjit::x86::r10, asmjit::Imm(a_vec[2] - a_vec[0])); 
    a.vpinsrq(asmjit::x86::xmm3, asmjit::x86::xmm3, asmjit::x86::r10, asmjit::Imm(0));
    a.mov(asmjit::x86::r11, asmjit::Imm(a_vec[3] - a_vec[0])); 
    a.vpinsrq(asmjit::x86::xmm0, asmjit::x86::xmm3, asmjit::x86::r11, asmjit::Imm(1));

    a.vinserti128(asmjit::x86::ymm0, asmjit::x86::ymm0, asmjit::x86::xmm1, asmjit::Imm(1));

    a.vpcmpeqw(asmjit::x86::ymm3, asmjit::x86::ymm3, asmjit::x86::ymm3);     // xmm3: mask to all 1s
    //a.vxorpd(asmjit::x86::xmm1, asmjit::x86::xmm1, asmjit::x86::xmm1);
    asmjit::x86::Mem vx_ptr = asmjit::x86::ptr(asmjit::x86::rax, asmjit::x86::ymm1, 1);
    a.vgatherqpd(asmjit::x86::ymm0, vx_ptr, asmjit::x86::ymm3);
